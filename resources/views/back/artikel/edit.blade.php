            ...
            <div class="card full-height">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Form Edit Artikel {{ $artikel->judul }}</div>
                    ...
                    <form action="{{ route('artikel.update', $artikel->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori_id" class="form-control">
                                @foreach ($kategori as $rowfarrel)
                                @if ($rowfarrel->id == $artikel->kategori_id)
                                <option value={{ $rowfarrel->id }} selected='selected'>{{ $rowfarrel->nama_kategori }}</option>
                                @else

                                <option value="{{ $rowfarrel->id }}">
                                    {{ $rowfarrel->nama_kategori }}</option>
                                @endif
                                @endforeach
                            </select>
                        </div>
