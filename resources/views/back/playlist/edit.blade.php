            ...
            <div class="card full-height">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Form Edit Playlist {{ $playlist->judul_playlist }}</div>
                ...
                <div class="card-body">
                    <form action="{{ route('playlist.update', $playlist->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" id="editor1" value="{{ $playlist->deskripsi }}" class="form-control"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <label for="gambar_playlist">Gambar Saat Ini</label><br>
                            <img src="{{ asset('uploads/' . $playlist->gambar_playlist) }}" width="250">
                        </div>
